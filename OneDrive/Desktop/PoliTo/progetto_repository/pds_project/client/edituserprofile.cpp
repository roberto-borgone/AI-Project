    ...
    h(h)
{
    ...
    mainLayout3 = new QGridLayout();
    mainLayout4 = new QGridLayout();
    ...
    newDateOfBirth = new QCalendarWidget();
            ...
            if(!oldPassword->text().isEmpty() && !newPassword->text().isEmpty() && !confirmNewPassword->text().isEmpty()) {
                ...
                if(re.exactMatch(oldPassword->text()) == false || re.exactMatch(newPassword->text()) == false){
                    ...
                    if(newPassword->text().compare(confirmNewPassword->text()) != 0){
                        ...
                        // NON MANDARE LE PASSWORD IN CHIARO E CAMBIARE DA MD5 A SHA256
                          editSend += ";"+oldPassword->text()+";"+newPassword->text()+";"+confirmNewPassword->text();
                    }
                  }
              }
              ...
              qDebug()<<editSend;
              if(s->write(editSend.toUtf8()) != editSend.size()) error = true;
