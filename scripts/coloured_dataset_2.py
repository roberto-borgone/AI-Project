...
dataset = 'C:\\Users\\Marianna\\Desktop\\coloured dataset2.2'
...
#        im1.show()
        ...
        while (num2==num3) or (num2!=num3 and img_file.find(str(num2))==False and img_file.find(str(num3))==False):
            num2 = random.randint(1, path_len1)
            num3 = random.randint(1, path_len1)
...
#        im3.show()
        ...
        # sets with the same images and same colors
